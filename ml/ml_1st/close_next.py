...
plt.plot(result_df.index, result_df['Predicted'], label='Predicted Next Close', color='red', linestyle='--', linewidth=2)

plt.title('Test Set: Actual vs. Predicted Next Close Price (Regression)')
plt.xlabel('Date')
